...
document.body.innerHTML += `Qual o primeiro índice da letra Z no seu nome? <strong>
    ${nome.indexOf("z")}
</strong><br />`;
document.body.innerHTML += `Qual o último índice da letra M no seu nome? <strong>
    ${nome.lastIndexOf("M")}
</strong> <br />`;
